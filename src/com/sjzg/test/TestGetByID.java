...
public class TestGetByID extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<TestModel> DBfindTest_result = DBfindTest(TestID);
		...
		if (DBfindTest_result.isEmpty()){
			...
			for (int i=listCount-1;i>=0;i--){
				...
				tempObject.addProperty("State", DBfindTest_result.get(i).getState());
	...
	public ArrayList<TestModel> DBfindTest(int TestID) {
		...
		try {
			...
			while(rs.next())
			{
				...
				testModel_temp.setState(rs.getString("State"));
