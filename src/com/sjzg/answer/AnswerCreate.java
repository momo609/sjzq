...
public class AnswerCreate extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			for(int i=0;i<answerArray.size();i++){
				...
				answerModel_temp.setTimeUsed(answerArray.get(i).getAsJsonObject().get("TimeUsed").getAsInt());
	...
	public String DBcreateAnswer(ArrayList<AnswerModel> answerList) {
		...
		String sql="INSERT INTO Answer(UserID,QuestionID,TestID,TimeUsed,Track,Grade,Unfocus,Appear,UserAnswer,CreateAt,UpdateAt) VALUES";
		...
		try {
			...
			for(int i=0;i<answerList.size();i++){
				...
				ps.setInt(4+(i*11), answerList.get(i).getTimeUsed());
