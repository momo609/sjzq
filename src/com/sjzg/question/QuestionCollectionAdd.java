...
public class QuestionCollectionAdd extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public QuestionCollectionAdd() {
		super();
	}
	...
	String DBcreateQuestionCollection_result = DBcreateQuestionCollection(QuestionID,UserID);
		
		if (!DBcreateQuestionCollection_result.equals("ok")) {
			out.print("{\"errcode\":101,\"errmsg\":\""+DBcreateQuestionCollection_result+"\"}");
			out.flush();
			out.close();
			return;
	...
	public String DBcreateQuestionCollection(int QuestionID,  String UserID) {
		System.out.println("执行DBcreateQuestionCollection");
		String sql="INSERT INTO Question_collection(QuestionID,UserID,CreateAt,UpdateAt) VALUES(?,?,?,?)";
