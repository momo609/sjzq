...
public class QuestionShareUser extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public QuestionShareUser() {
		super();
	}
	...
	String DBcreateQuestionShare_result = DBcreateQuestionShare(QuestionID,UserID);
		
		if (!DBcreateQuestionShare_result.equals("ok")) {
			out.print("{\"errcode\":101,\"errmsg\":\""+DBcreateQuestionShare_result+"\"}");
			out.flush();
			out.close();
			return;
	...
	public String DBcreateQuestionShare(int QuestionID,  String UserID) {
		System.out.println("执行DBcreateQuestionShare");
		String sql="INSERT INTO Question_share(QuestionID,UserID,CreateAt,UpdateAt) VALUES(?,?,?,?)";
