...
public class QuestionQueryAll extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public QuestionQueryAll() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<QuestionModel> DBfindQuestion_result = DBfindQuestion(offset);
	...
	public ArrayList<QuestionModel> DBfindQuestion(int offset) {
		System.out.println("完成执行DBfindQuestion");
		String sql="SELECT Question.*,User.* FROM  Question , User " +
				"WHERE Question.Share=1 " +
				"AND Question.UserID = User.UserID ORDER BY Question.UpdateAt DESC LIMIT ?,20; ";
