...
public class QuestionGetByPaper extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.setCharacterEncoding("UTF-8");//璁剧疆瀵瑰鎴风璇锋眰杩涜閲嶆柊缂栫爜鐨勭紪鐮併�
		response.setCharacterEncoding("UTF-8");//鎸囧畾瀵规湇鍔″櫒鍝嶅簲杩涜閲嶆柊缂栫爜鐨勭紪鐮併�
		response.addHeader("Access-Control-Allow-Origin", "*");//璺ㄥ煙
		PrintWriter out = response.getWriter();//鍔″繀鏀惧湪鏈�悗
		...
		String[] questionList = questionListStr.split("@@");//涓㈠純绌哄瓧绗︿覆
