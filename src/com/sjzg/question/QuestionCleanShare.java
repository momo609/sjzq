...
public class QuestionCleanShare extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public QuestionCleanShare() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//第一步，取数据
				...
				String DBcleanQuestionShare_result = DBcleanQuestionShare(QuestionID);
				
				if (DBcleanQuestionShare_result.equals("ok")) {
					out.print("{\"errcode\":0,\"errmsg\":\"成功\"}");
					out.flush();
					out.close();
					return;
				}else {
					out.print("{\"errcode\":101,\"errmsg\":\""+DBcleanQuestionShare_result+"\"}");
					out.flush();
					out.close();
					return;
				}
	}
	public String DBcleanQuestionShare(int QuestionID) {
		System.out.println("执行DBcreateQuestionShare");
		String sql="DELETE FROM Question_share WHERE QuestionID=?";
