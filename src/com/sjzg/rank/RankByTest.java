...
public class RankByTest extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		for (int m=0;m<RankModel_result.size();m++){
			...
			RankModel_result.get(m).setIndex(current_index);
			RankModel_result.get(m).setContent("得分:"+(RankModel_result.get(m).getValue()*10));
		...
		jsonObject.addProperty("average",totalScore/RankModel_result.size());
