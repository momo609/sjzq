...
public class UserReset extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(updateString.equals("error")){
			...
			String DBupdateUserPassword_result = DBupdateUserPassword(Password,MobilePhone);
	...
	public String DBupdateUserPassword(String Password,String MobilePhone) {
		System.out.println("执行DBupdateUser");

		String sql="UPDATE User SET Password = ? , UpdateAt = ? WHERE MobilePhone=? ";
