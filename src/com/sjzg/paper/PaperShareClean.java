...
public class PaperShareClean extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public PaperShareClean() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//第一步，取数据
				...
				String DBcleanQuestionShare_result = DBcleanPaperShare(PaperID);
	...
	public String DBcleanPaperShare(int PaperID) {
		System.out.println("执行DBcreateQuestionShare");
		String sql="DELETE FROM Paper_share WHERE PaperID=?";
